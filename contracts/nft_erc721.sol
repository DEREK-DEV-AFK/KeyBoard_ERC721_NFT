...
// File: NFT/KeyboardNFT.sol
contract KeyboardNFT is ERC721URIStorage {
    ...
    modifier ReentrancyGuard(){
        require(!inProccess,"functions are a bit busy try again in a few");
        inProccess = true;
        _;
        inProccess = false;
    }
